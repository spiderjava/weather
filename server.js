...
app.post('/', function (req, res) {
  ...
  let sfquery=`select name, name__c, duration__c, event_date__c, description__c from salesforce.social_event__c where event_date__c between '2019-09-10' and '2019-09-30'and city__c='${req.body.city.toLowerCase()}'`;
    ...
    pgclient.query(sfquery, (err, dbres) => {
        ...
        request(url, function (err, response, body) {
            ...
            if(weather != undefined){
                ...
                let weatherText = `Weather is ${weather.weather} with ${tempCels} degrees of temperature and XXX% of humidity in ${weather.city}!`;
                // ${weather.humidity}
                //COMPOSE RESPONSE
